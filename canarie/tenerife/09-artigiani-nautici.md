...
⚠️ Contatti sotto riportati solo se verificati su fonte diretta (siti ufficiali); dove manca la conferma la voce resta **DATO MANCANTE** e viene ricercata nei controlli mensili. Nulla viene inventato.
...
- Meccanici freelance ed elettricisti navali in zona Marina Santa Cruz: elenco da richiedere in capitaineria — **DATO MANCANTE**.
- Sailmaker locali: **DATO MANCANTE** (Spinnaker tratta veleria ma non risulta loft proprio).
...
- **Elettronica B&G/Simrad/Lowrance**: Spinnaker Shop in centro è il riferimento verificato; per **Raymarine** nessun assistente locale confermato (**DATO MANCANTE**).
