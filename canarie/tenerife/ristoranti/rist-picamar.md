...
| Campo | Dettaglio |
|---|---|
| Zona | Costa Adeje – Av. de España 5, CC Terranova (a due passi da Puerto Colón) |
| Cucina | 🥙 Tapas creative di mare con tocchi asiatici |
| Specialità | Pulpo *(polpo)* · gambas *(gamberoni canari)* · pimientos de Padrón *(peperoni di Padrón)* |
...
- Pimientos de Padrón *(peperoni di Padrón)*
- Tacos con guacamole *(tacos al guacamole)*
- Bao *(bao)*
- Gyoza *(gyoza)*
