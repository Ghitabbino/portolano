...
|---|---|---|---|---|---|
| **Graceway Gourmet / IGA – Providenciales** | Leeward Hwy & Grace Bay, Providenciales | ~1–3 km da Turtle Cove | ⚠️ taxi | DATO MANCANTE | Consegna limitata ★★ |
...
- Mercato ortofrutticolo del capoluogo (Cockburn Town (Grand Turk)): frutta/verdura locale, mattino presto. ★★
...
| Servizio | Dove | Note |
|---|---|---|
| Water dock | Marina principale Providenciales Turtle Cove / South Bank | DATO MANCANTE tariffa/m³ — verificare in capitainerie → [03](03-porti-ancoraggi.md) |
...
- Minibus / bus locali: frequenti sulle direttrici principali (es. Cockburn Town (Grand Turk) ↔ marina), passaggio ogni 15–30 min di giorno, biglietto ~1–2 USD. ★★
