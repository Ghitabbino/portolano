...
- **Ocean Posse Risk Advisory (ago 2026)**: Venezuela in "fase transitoria — shift politico, non miglioramento per gli yacht"; clausole war-risk assicurative ancora attive; evitare acque/porti VE [Ocean Posse] ★★★.
- **Fonti diportiste aggregate Security finale (agg. 4 ago 2026)** ★★★: rischio estremo confermato; AIS e luci sempre ON; float plan (boatwatch.org / USCG); SAR VE non affidabile → riferirsi a JRSC San Juan.
- **Pirateria storica zone specifiche**: Paria = ultimo boarding armato (20 pirati) set 2021 [Fonti diportiste aggregate] ★★; **Margarita e Testigos** = borseggi, rapine, aggressioni con coltello a navigatori [Fonti diportiste aggregate Security] ★★★; **Porlamar**: "piracy is a growing threat in the waters around Isla Margarita" [Ocean Posse] ★★; **acque Trinidad-Venezuela ed est di Puerto La Cruz** indicate da FCDO per pirateria/rapina armata [GOV.UK, cit. in OP] ★★★.
- **Offshore recente**: dic 2024 catamarano Los Roques→Grenada respinge pirates armati; ott 2024 veliero colpito da proiettile vagante offshore [Fonti diportiste aggregate incident list] ★★★.
- **Dove i cruisers vanno davvero oggi** (secondo Fonti diportiste aggregate 2026): Los Roques, **Blanquilla** (Guardia Nazionale ivi dislocata stabilmente), Aves de Sotavento e Barlovento — ma "ciò che era 'safe' 6 mesi fa può non esserlo ora" [Fonti diportiste aggregate Security, 2026] ★★★.
...
Vedi cronologia in testa pagina (2 set 2025–ago 2026): strikes narcolanchas, Fonti diportiste aggregate avviso nov 2025, advisory USA Level 4, operazione gen 2026, Ocean Posse ago 2026. Pirateria storica Paria 2021, Margarita/Testigos frequenti. Offshore 2024 due incidenti. ★★★
...
- **Relativamente frequentati ma non garantiti**: Los Roques, Blanquilla (Guardia Nazionale), Aves — ma "safe 6 mesi fa può non esserlo ora" [Fonti diportiste aggregate 2026]. ★★★
...
| Data | Fonte | Azione |
|---|---|---|
| 24/08/2026 | Fonti diportiste aggregate, Caribbean Compass, US Embassy, CSSN, Ocean Posse | Verifica completa — confermato rischio L3, nessun allentamento |
