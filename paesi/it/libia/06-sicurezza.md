...
| Furti materiali a bordo | **DATO MANCANTE /5** | **DATO MANCANTE** — verificare segnalazioni furti dinghy/fuoribordo nelle marine libia |
...
- Advisory: **DATO MANCANTE** — da consultare viaggiareinsicurezza.it (Libia), diplomatie.gouv.fr, gov.uk, travel.state.gov, voyage.gc.ca.
...
|---|---|---|
| Emergenza generale UE | **112** | Valido anche in Libia se in UE; altrimenti **DATO MANCANTE** |
| Guardia costiera / MRCC | **DATO MANCANTE** | Verificare su elenco SAR Libia |
