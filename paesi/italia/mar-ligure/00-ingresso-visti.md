...
| Zona | **Mar Ligure** — suddivisione portolano |
| Documenti UE | Carta d'identità o passaporto validi |
| Visto UE | Non richiesto (libera circolazione) |

> Dettaglio ingressi via mare per questa zona: **DATO MANCANTE** — da verificare presso Capitaneria di Porto competente per Mar Ligure.

## Specificità di zona

- Approdi di ingresso con Polizia di Frontiera in Mar Ligure: **DATO MANCANTE** — verificare elenco Porti di Ingresso su mit.gov.it / Polizia di Stato ★★★★★
