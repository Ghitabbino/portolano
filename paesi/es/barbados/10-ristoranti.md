...
*Marcadores clicables: el popup abre directamente la ficha del restaurante. Tasselli locali zoom 7–15 (satellitare / carta nautica / segnali OpenSeaMap). Coordinate WGS84 da fonti locali ufficiali (barbados.org / totallybarbados.com) e siti dei ristoranti — verificare sempre con Google Maps prima di muoversi.*
...
> **Nota siti locali (regola 14):** per ogni ristorante sotto è riportata la valutazione **barbados.org + totallybarbados.com** (locale) + Google/TripAdvisor dove disponibili, con data di verifica **28/08/2026** e rank ★. Se un dato non è verificato su sito locale → **DATO FALTANTE** per recensioni, ma la scheda resta con mappa e contatti. Nessun dato inventato.
