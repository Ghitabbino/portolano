...
**Última verificación completa: 28/08/2026** · Prossimo controllo mensile: **28/09/2026**

## Evaluación seguridad: **3 / 5**

| Aspecto | Valoración | Motivación |
|---|---|---|
| Seguridad personal (turistas/cruceristas) | 3/5 | Avisos USA/UK/Canadá **Level 1 “normal precautions”** — hurtos comunes, violencia dirigida a turistas rara pero robos oportunistas frecuentes en zonas turísticas |
| Robos materiales a bordo | 2/5 | Dinghy/fueraborda y objetos en cockpit = problema recurrente en rada y pantalanes (CSSN: 37 incidentes en 5 años en radio 10 km desde Le Marin-Martinica como referencia; en Barbados fenómeno análogo en Carlisle/Bridgetown) |
| Contexto general de la isla | 3/5 | **50 homicidios en 2024 (+17,7/100k)**, criminalidad general en ligero descenso (-4% 2024→2025) pero **delitos con arma de fuego +60%**; violencia ligada a bandas, concentrada entre locales y en algunas parishes — turistas no son objetivo primario |

*Escala: 0 = terrible → 5 = muy seguro. Valoración propia, síntesis de las fuentes abajo; actualizada en cada control mensual.*
...
| Zona | Note | Fonte |
|---|---|---|
| Shallow Draught / Careenage (Bridgetown) de día | Vigilado, aduana/Port Health in situ; robos posibles igualmente — candado obligatorio |BPI ★★★★|
...
| Ropa de camuflaje | **Ilegal** vestir de camuflaje o llevar objetos miméticos — decomisables en aduana (válido en todo el este del Caribe) |OSAC/ travel.state.gov ★★★★|
...
| Aproximación a Bridgetown | Puerto comercial congestionado; mantenerse fuera del canal de buques hasta instrucciones de Signal Station VHF 12; **no** dirigirse al muelle de aduana con barcos <20 m — dinghy al Passenger Terminal |BPI ★★★★★ · Fuentes náuticas agregadas 31/12/2022 ★★|
