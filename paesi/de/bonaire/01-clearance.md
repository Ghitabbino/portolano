...
2. Preparare in cartella (originali + 2 copie):
   ...
   - **documento di uscita (zarpe/despacho) del porto precedente — obbligatorio**: senza prova del Paese di provenienza l'ingresso può essere rifiutato (controllo applicato anche su arrivi dal Venezuela/Los Roques). Aggregierte Fahrtensegler-Quellen ★★★; [Doyle Guides — Bonaire Updates 30/05/2017](https://doyleguides.com/bonaire-updated-guide/) ★★
...
| Voce | Costo | Fonte |
|---|---|---|
| Clearance Dogana + Immigrazione (ingresso/uscita) | **Gratuita** (in orario) | Aggregierte Fahrtensegler-Quellen ★★★; [CruisersWiki] ★★ |
...
- Dal 2023 la Dogana si aspetta SailClear pre-compilato: chi arriva senza trova solo moduli cartacei e tempi più lunghi. ★★★ [Aggregierte Fahrtensegler-Quellen ★★★
