...
Costa e approdi di Adriatico: **DATO MANCANTE** per descrizione sistematica verificata. Mappa d'insieme centrata su 43.00N 14.50E (indicativo di zona).

## Marine principali (da verificare)

| Marina / Porto | Zona | Posti | Note |
|---|---|---|---|
| **DATO MANCANTE** | Adriatico | **DATO MANCANTE** | **DATO MANCANTE** — da verificare su Pagine Azzurre / Capitaneria |
