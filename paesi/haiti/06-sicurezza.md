...
|---|---|---|
| **Haiti** — sicurezza generale | **0,5/5** | **Estremo: evitare**. Controllo territoriale di gang armate, rapimenti, collasso servizi, colera endemico. Sconsigliato da tutte le fonti governative e da Fonti diportiste aggregate ★★★★★ |
...
- **Evitare la navigazione da diporto in acque haitiane** se non per emergenza. Fonti diportiste aggregate: **"Haiti — gang, colera, sconsigliato"**; servizi di soccorso e autorità portuali intermittenti. ★★★★
...
## Furti a crocieristi (CSSN / rete sicurezza diportisti)
...
| Emergenza | Numero |
|---|---|
| **Numero unico emergenze Haiti** | **114** (Police Nationale) · **116** (ambulanza/pompieri) — copertura limitata ★★ |
| **Semanah / MRCC Haiti** | **VHF 16** (presidio intermittente) ★★ |
| Emergenze gravi in mare: valutare coordinamento con **MRCC RD** (VHF 16 / 911), più reattivo | ★★ |

### Ambasciata d'Italia a Santo Domingo

- **Ambasciata d'Italia — Santo Domingo**: **+1 809-508-4500** — `ambsantodomingo.esteri.it` — assistenza consolare per RD e, in via residuale, **anche per Haiti** (non esiste ambasciata italiana a Port-au-Prince). In caso di emergenza fuori orario: cellulare di reperibilità pubblicato sul sito ambasciata. ★★★★★

### Haiti — numeri (indicativi)

| Emergenza | Numero |
|---|---|
| Police Nationale d'Haïti | **114** |
...
- **Coordinamento alternativo**: **MRCC Repubblica Dominicana** (VHF 16 / 911) più reattivo; **JRCC USA (Miami)** su 2182 kHz / VHF 16 per emergenze gravi in area Hispaniola. ★★

## Monitoraggio mensile (per agenti)

- Fonti da ricontrollare ogni 30 gg: `travel.state.gov` (advisory Haiti), `gov.uk/foreign-travel-advice/haiti`, `voyage.gc.ca`, `Fonti diportiste aggregate`, `CSSN (safetyandsecuritynet.org)`, stampa locale haitiana, gruppi FB cruisers Hispaniola. Aggiornare valutazione 0,5/5 e banner L3 se evento <90 gg con 2 fonti ★★★★★. ★★
