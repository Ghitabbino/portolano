...
| Menu fascia alta/resort | **DATA MISSING** |
| Street food (roti, BBQ) | **DATA MISSING** |
...
| Taxi (targa azzurra TX) | Tariffe libere, concordare sempre prima; tabella ufficiale assente → tratte specifiche **DATA MISSING** | stlucia.org ★★★★ |
| Noleggio auto giornaliero | **DATA MISSING** | Verificare agenzie Rodney Bay/aeroporto |
...
| Lavanderia self-service | **DATA MISSING** | Presente in marina [IGY ★★★★] |
...
| Lavaggio scafo (hull dive) | **DATA MISSING** | Chiedere ai diver del boatyard IGY |
