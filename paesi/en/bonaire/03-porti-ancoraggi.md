...
- Gestione **boe overnight STINAPA per visitatori**: assegnazione first-come first-served via Harbour Village Marina, pagamento in loco; usare **cima propria ≥6 m** (non legarsi direttamente alla boa), una yacht per boa, max **18 m (55–58 ft)**, holding tank obbligatorio, no attività commerciali a bordo, rispetto durata visto. [STINAPA](https://stinapabonaire.org/rules-and-regulations/mooring/) ★★★★★
- Dinghy dock: tender al **Karel's Bar** (consumazione gradita) or molo Dogana (posti ufficiali — lasciare spazio). Chiudere sempre tender e fuoribordo. ★★
- Contatti: tel **+599 717 7419** / WhatsApp **+599 701 7500** · dockmaster@harbourvillage.com · Orari: lun–ven 8:30–12:00 & 13:30–17:00, sab 8:00–13:00. [Harbour Village Marina](https://www.harbourvillage.com/bonaire-marina) ★★★★
...
- **J.A. Abraham Blvd 80, Kralendijk (~12°08,6' N 68°16,5' W — DATA MISSING coordinata ufficiale verificata)** · tel **+599 717 2500** / marina@bonaire.valk.com · VHF DATA MISSING ★★★
- Marina interna al resort, a pochi minuti a piedi da Kralendijk centro; posti galleggianti per imbarcazioni da diporto e charter (Bonaire Yacht Charters), accesso resort (piscine, PADI 5★ dive). Ideale per chi pernotta al resort or per sosta breve con servizi alberghieri. [Plaza Resort — Marina](https://www.plazaresortbonaire.com/en/facilities/marina) ★★★
...
### Klein Bonaire
- Isola disabitata a **0,8 km (0,4 M)** sottovento a Kralendijk, riserva naturale e tartarughe. Solo **mooring gialli/blu day-use max 2 h** (una yacht >4 m per boa or fino a 3 tender <4 m), **pernotto vietato**; max **13 m**. Rispettare reef e sentieri subacquei. [STINAPA](https://stinapabonaire.org/rules-and-regulations/mooring/) ★★★★★
...
Pagamenti anticipati, check-out a mezzogiorno. Prenotazione: [Request Slip](https://www.harbourvillage.com/bonaire-marina). Fonte: [Harbour Village — Marina Rates & Services](https://www.harbourvillage.com/bonaire-marina). Minimo Dock A&B 40 ft.
...
| Elettricità 50 Hz | **0,75 USD/kWh** | 127–130V 30A e 230–240V 50A |
| Acqua di banchina | **0,10 USD/gal (~26 USD/m³)** | Desalinizzata potabile |
...
| Catamarano / beam largo | **DATA MISSING** supplemento | Chiedere a sales@plazaboatclub.com |
...
| Item | Cost | Notes |
|---|---|---|
| Boa overnight bicolore (visitatori, 30–51 boe) — notte | **35 USD** | First-come first-served, max 18 m, tramite Harbour Village Marina; pagamento in loco [InfoBonaire](https://infobonaire.com/getting-to-bonaire/yachting-cruising/) ★★★ ; [STINAPA 2023](https://stinapabonaire.org/rules-and-regulations/mooring/) ★★★★★ ; stagionale 2022: 11 USD (10+1) hurricane season [Bonaire Reporter 27/05/2022] ★★ |
| Boa day-use gialla/blu — 2 h | **Gratuita / inclusa Nature Fee** | Max 2 h consecutive, max 13 m, una yacht >4 m per boa |
| Boa privata (residenti) | **1.000 USD/anno** | Riservata residenti con sédula, waitlist ~3 anni — non utilizzabile |
| Ancoraggio libero | **Vietato** | Ovunque nel Parco Marino (fino a batimetrica), sanzione fino a 2.800 USD + reclusione ★★★ |

### Other Facilities

| Facility | Cost/Notes | Source |
|---|---|---|
| Bonaire Nautico Marina | DATA MISSING — chiedere +599 9560 7254 | [InfoBonaire — List of Marinas](https://infobonaire.com/getting-to-bonaire/yachting-cruising/) ★★★ |
| Ocean Breeze Marina | DATA MISSING — chiedere +599 786 3006 | ★★★ |
...
⚠️ **To be verified prima della crociera**: disponibilità boe overnight e posti marina in alta stagione (dic–apr) — chiamare Harbour Village prima della traversata; tariffe aggiornate Plaza Marina; eventuali variazioni VHF 17 vs 12 e orari Dogana/IND; restrizioni temporanee Parco Marino (es. nidificazione tartarughe su Klein Bonaire).
...
| Traversate inter-islands Leeward vicine | 15–45 M tra islands | Dato generale caraibico ★★ |
