...
| Field | Detail |
|---|---|
| **Depth** | ~4,5 m all'ingresso; bacino interno protetto con fondale sabbia/corallo dragato |
| **Holding** | — (marina resort, non ancoraggio: **àncora vietata** nel BNMP) |
| **Wind/Shelter** | Ottimo riparo dagli alisei ENE (bacino a nord di Kralendijk); esposta a swell N/NO con fronti freddi — verificare bollettino prima dell'ingresso ★★ |
| **Hazards** | Traffico resort/charter all'ingresso; fondale che degrada rapidamente fuori dal bacino; reef a sud dell'imboccatura |
| **Buoys/Restrictions/Regulations** | **Gestore ufficiale delle boe overnight STINAPA** per visitatori: assegnazione first-come via VHF 17 (e 12), pagamento in loco US$ 35/notte, briefing uso boa (cima ≥6 m, max 18 m, una yacht/boa) ★★★★★; Dogana/Immigrazione a 0,5 M a sud (Fort Oranje) — unico porto d'ingresso |
| **Ashore** | Resort 5★ full-service: **60 posti** fino a 60 ft + mega-yacht dock fino a **240 ft (Ambar Point)**; acqua US$0,10/gal, elettricità US$0,75/kWh (127–130V 30A / 230–240V 50A), diesel/benzina + bunker >10.000 l via Curoil, pump-out WiFi docce lavanderia parcheggio sicurezza inclusi; prenotazione [Request Slip](https://www.harbourvillage.com/bonaire-marina) |
