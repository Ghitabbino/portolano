...
| **Zhung Kong / mini-markets cinesi** | Kaya Gob. N. Debrot / Kaya Tintorero | 0,5–2 km diffusi | ✅ sì | Lun–dom 7–20 ca. · tel **DATA MISSING** · piccoli chinese tokos per last-minute, aperti festivi quando gli altri chiudono |guide locali ★★|

Chandler/nautica in zona marina per ricambi limitati (verificare Budget Marine or Harbour Village); prezzi alti per importazione. ★★
...
Rincon, Nikiboko, Antriol, Belnem: toko/mini-market di quartiere, assortimento base; per il fresco/varietà tornare a Kralendijk. Orari variabili — **DATA MISSING** dettagli verificati per ogni frazione al prossimo controllo. ★★
...
- Assenza di grande mercato coperto tipo Fort-de-France; spezie/frutta tropicale nei supermarket or bancarelle. ★★

## Water & Fuel

| Service | Where | Notes |
|---|---|---|
| Water dock | Harbour Village Marina / Kralendijk Yacht Harbour | **DATA MISSING** tariffa/m³ verificata — chiedere in capitainerie; acqua WEB potabile (osmosi) → [03](03-porti-ancoraggi.md) |
...
- Carrello/trolley pieghevole + borse termiche: indispensabili; da Van den Tweel/Warehouse tutto è a portata di taxi breve (tariffa flat per destinazione, da concordare prima di salire) or a piedi.
