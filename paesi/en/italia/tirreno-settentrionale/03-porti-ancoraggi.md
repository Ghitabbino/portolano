...
Costa e approdi di Tirreno Settentrionale: **DATO MANCANTE** per descrizione sistematica verificata. Mappa d'insieme centrata su 42.50N 10.80E (indicativo di zona).

## Marine principali (da verificare)

| Marina / Porto | Zona | Posti | Note |
|---|---|---|---|
| **DATO MANCANTE** | Tirreno Settentrionale | **DATO MANCANTE** | **DATO MANCANTE** — da verificare su Pagine Azzurre / Capitaneria |
