...
| Furti materiali a bordo | **DATA MISSING /5** | **DATA MISSING** — verificare segnalazioni furti dinghy/fuoribordo nelle marine siria |
...
- Advisory: **DATA MISSING** — da consultare viaggiareinsicurezza.it (Siria), diplomatie.gouv.fr, gov.uk, travel.state.gov, voyage.gc.ca.
...
|---|---|---|
| Emergenza generale UE | **112** | Valido anche in Siria se in UE; altrimenti **DATA MISSING** |
| Guardia costiera / MRCC | **DATA MISSING** | Verificare su elenco SAR Siria |
