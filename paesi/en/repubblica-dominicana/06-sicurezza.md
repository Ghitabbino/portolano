...
| **Haiti** — sicurezza generale | **0,5/5** | **Estremo: evitare**. Controllo territoriale di gang armate, rapimenti, collasso servizi, colera endemico. Sconsigliato da tutte le fonti governative e da Cruising sources aggregate ★★★★★ |
...
## Overview — Repubblica Dominicana
...
- **Ambasciata d'Italia — Santo Domingo**: **+1 809-508-4500** — `ambsantodomingo.esteri.it` — assistenza consolare per RD e, in via residuale, per Haiti. In caso di emergenza fuori orario: cellulare di reperibilità pubblicato sul sito ambasciata. ★★★★★
