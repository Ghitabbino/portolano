...
Hub principale **DATA MISSING** — da verificare (possibili poli: Barcellona, Valencia, Palma di Mallorca). Contatto tipico via telefono / WhatsApp; si parla montenegro e spesso inglese. Per lavori importanti chiedere sempre **presupuesto** (preventivo scritto) e confermare i tempi in alta stagione.
...
- **Tempi**: ricambi dall'Europa = 1–2 settimane tipicamente — **DATA MISSING** su dettagli locali.
