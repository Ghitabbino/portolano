...
**Last checked: 27/08/2026** · Coordinate in gradi decimali o N/W come da fonte — **DATA MISSING** dove non verificato

## Mediterranean Coast — Overview

L'arcipelago maltese (Malta, Gozo, Comino) è nel Canale di Sicilia, tra Sicilia e Nord Africa. **DATA MISSING** su suddivisione dettagliata per rade/baie — da verificare su Transport Malta.

### DATA MISSING — area principale / porto di ingresso

- **DATA MISSING** — porti, coordinate, VHF, servizi. Verificare su elenco ufficiale Port Authority Malta.
