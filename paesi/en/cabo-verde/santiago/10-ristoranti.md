...
|---|---|---|---|---|---|
| **Ristorante del porto** | Porto principale santiago | **€–€€** | 🐟 creola | Pesce del giorno, cachupa | A piedi dal pontile ★★ |
...
**DATA MISSING** — tasselli mappa offline non ancora generati per santiago; usare cartografia ufficiale.
