...
- Advisory: **DATA MISSING** — from consultare viaggiareinsicurezza.it (Grecia — Dodecaneso), diplomatie.gouv.fr, gov.uk, travel.state.gov, voyage.gc.ca.
- Stampa locale / report isola: **DATA MISSING**.
- Nessuna valutazione definitiva fino a verifica mensile completa.

## Zone Map — Offline

<div class="mapframe" data-slug="grecia-dodecaneso" data-minz="5" data-maxz="15" data-lat="36.40" data-lon="-27.20" data-zones='[]'></div>

*Legend: **DATA MISSING** — zone from mappare dopo verifica. Mappa placeholder centrata on Grecia — Dodecaneso.*
