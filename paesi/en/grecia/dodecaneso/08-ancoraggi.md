...
*In preparazione: mappa placeholder centrata on Egeo / Ionio — Dodecaneso. I marker verranno aggiunti only with coordinate verificate WGS84. Tasselli locali zoom 5–13 (satellitare / carta nautica / segnali OpenSeaMap) — from generare dopo inserimento punti reali.*
...
|---|---|---|
| **Hellenic Navy Hydrographic Service (HNHS)** | Coste greche | Carte ufficiali Grecia — Dodecaneso — **DATA MISSING** on numeri/nomenclatura for tratto |
| **NV Charts / Imray** | Mediterraneo Grecia — Dodecaneso / Baleari | Alternativa plaisance, WGS84 — **DATA MISSING** on edizioni |
...
## Anchor Checklist for la Grecia — Dodecaneso
