...
- Advisory: **DATA MISSING** — from consultare viaggiareinsicurezza.it (Grecia — Cicladi), diplomatie.gouv.fr, gov.uk, travel.state.gov, voyage.gc.ca.
- Stampa locale / report isola: **DATA MISSING**.
- Nessuna valutazione definitiva fino a verifica mensile completa.

## Zone Map — Offline

<div class="mapframe" data-slug="grecia-cicladi" data-minz="5" data-maxz="15" data-lat="37.00" data-lon="-25.10" data-zones='[]'></div>

*Legend: **DATA MISSING** — zone from mappare dopo verifica. Mappa placeholder centrata on Grecia — Cicladi.*
