...
**Last checked: 28/08/2026** · Coordinate in gradi decimali / N-W come da fonte · datum WGS84 · VHF 12 Bridgetown Signal, VHF 16 Port Control
...
## Costa ovest sottovento — Bridgetown e Carlisle Bay ⚓ area principale
...
- **Shallow Draught**: darsena protetta *dentro* il porto commerciale ma separata, dedicata agli yacht (~40 posti full services, acqua/corrente, security). È l'unica con **Dogana/Immigrazione dedicata agli yacht** ed è il POE consigliato a Bridgetown. Depth sufficiente per yacht (“shallow” solo per le navi). Prenotazione via Harbour Master tel +1 246 434-6100. [BPI news 2024-12](https://barbadosport.com/news/page/4) ★★★★ · [BPI Yacht Masters Guide](https://barbadosport.com/barbados-yacht-masters-guide) ★★★★
...
- Clearance in loco (Shallow Draught or Passenger Terminal — vedi [01](01-clearance.md)). Chiamare **Signal Station VHF 12 prima di entrare**, berth assegnato; bandiera Q. Orari **06:00–22:00 7/7** al Passenger Terminal secondo segnalazioni — verificare VHF.
- Protezione: buon ridosso dagli alisei; risacca con swell da N/NW in caso di mareggiate invernali or uragano di passaggio — verificare bollettino locale prima dell'ingresso. Pontile dinghy sabbioso: canotto a spiaggia, chiudere con lucchetto. ★★

### Carlisle Bay — ancoraggio pubblico

- **13°04,69' N 59°37,66' W (centro rada, ~13.078 -59.627)** · sabbia, 5–14 m, buon holding. Vedi scheda [anc-carlisle-main](ancoraggi/anc-carlisle-main.md). È l'area dove quasi tutti i cruisers sostano dopo la clearance, a pochi minuti di dinghy dal boatyard e dal centro.

## Costa nord-ovest — Port St. Charles & Port Ferdinand (resort, calmi)

### Port St. Charles Marina — POE del nord ⚓
...
- **13°15,51' N 59°38,70' W (darsena interna, ancoraggio esterno Six Men's Bay)** · [Port Ferdinand](https://www.portferdinand.com) ★★ · [Yachting World 2017](https://www.yachtingworld.com/features/reinventing-barbados-caribbean-island-works-welcome-back-cruisers-71257) ★★★ · [Marinas.com — Port Ferdinand](https://marinas.com/view/marina/z4cr829_Port_Ferdinand_St_Peter_Barbados) ★★
- **NON è POE**: formalità a Bridgetown or Port St. Charles; serve **permesso costiero** del Customs Boarding Officer (tel +1 246 430-2355, VHF 16) per spostarsi lungo costa senza nuova clearance se già sdoganati. [BPI Yacht Masters Guide §8](https://barbadosport.com/barbados-yacht-masters-guide) ★★★★
- Darsena **scavata nella roccia**, 120–126 berths, adatta a superyacht, ingresso via Six Men's Bay **sotto ponte sollevabile** (attenzione al pescaggio aereo). Yacht grandi spesso all'ancora fuori in rada. Servizi resort completi (ristorante 13°/59°, beach club, spa). Vedi scheda [anc-port-ferdinand](ancoraggi/anc-port-ferdinand.md).
...
- **Oistins Bay (13°03,93' N 59°32,47' W)** — baia aperta a **S** con rada su 3–8 m sabbia, esposta al swell sud atlantico; tenibile **solo con mare calmo** (dic–apr migliore). Famosa per **Fish Fry del venerdì** e fish market, ma **non è rifugio affidabile** con aliseo sostenuto. Molte barche da pesca locali. Vedi [anc-oistins](ancoraggi/anc-oistins.md). [Navily — Oistins](https://www.navily.com/mouillage/oistins-fischerort/48071) ★★
- **St. Lawrence Gap / Worthing / Hastings** — litorale turistico con reef frangente, fondali sabbia/corallo, ancoraggio solo con bel tempo e mai per notte senza guardia; rispettare corridoi bagnanti. ★★

## Costa est atlantica — NON ancorabile (Bathsheba, Tent Bay, Consett Bay)
...
| Item | Cost | Notes |
|---|---|---|
| Posto pontile / banchina affiancata (~12 m) — notte | **DATA MISSING** — su richiesta Harbour Master | Careenage stern-to, Shallow Draught ~40 posti |
| Elettricità / acqua | **DATA MISSING** — a consumo secondo contratto | Verificare all'arrivo |
| Carburante in banchina (Shallow Draught) | **DATA MISSING** — stazione porto, prezzi variabili | Diesel / RON 95, verificare VHF |
...
| Item | Cost | Notes |
|---|---|---|
| Posto pontile Port St. Charles / notte (~12–15 m) | **DATA MISSING** — su richiesta +1 246 419-1000 | 6 berths mega-yacht su diga esterna fino a 250 ft; prenotazione obbligatoria |
| Posto pontile Port Ferdinand / notte | **DATA MISSING** — su richiesta +1 246 272-2020 | 120–126 berths, superyacht, ponte sollevabile |
| Elettricità / acqua resort | **DATA MISSING** — a consumo | Inclusi or a metro secondo contratto |
...
|---|---|---|
| Boe visita / mooring in riserva marina | Uso obbligatorio dove presenti (reef protetti, Carlisle Bay parco relitti); tariffa **DATA MISSING** (stimata 10–30 BBD/notte dove presente) | ★★ |
...
| Bridgetown — Oistins Bay | ~6 M (~11 km) | Costa sud, esposta a sud |
| Barbados — Santa Lucia (Rodney Bay) | ~95 M (~176 km) | Traversata ovest, finestra alisei |
| Barbados — Grenada | ~135 M (~250 km) | SW, traversata aperta |
