...
Barbados is an **independent parliamentary republic** since 30 November 2021 (former Commonwealth realm), a member of the Commonwealth, **outside the EU and outside the Schengen Area**: it has its own customs and immigration and is not part of the OECS. EU/Schengen rules do not apply. [immigration.gov.bb](https://immigration.gov.bb/pages/visitor.aspx) ★★★★★ · [gov.bb — Immigration Department](https://www.gov.bb/Departments/immigration) ★★★★★

## EU Citizens — No Visa for Short Stays
...
- **People** (Immigration) and **yacht** (Customs + Port Health + Port Authority) controls are **separate but linked**: the yacht must be presented at an **official Port of Entry** and the crew must have completed the **online Immigration & Customs Form**. Yacht clearance is mandatory on entry and on exit → see [01 — Clearance](01-clearance.md).
- **Ports of Entry (POE) for yachts: Bridgetown** (Shallow Draught dedicated to yachts + Deep Water Harbour on instruction) **and Port St. Charles Marina** (NW, clearance directly in the marina at the end of the breakwater). **Do not approach the cruise/commercial wharf** with a vessel <20 m: dangerous, no dinghy dock — better to stand off and proceed by dinghy to the Passenger Terminal on the instructions of the Signal Station. [Barbados Port Inc. — Vessel Documentation](https://barbadosport.com/vessel-documentation) ★★★★★ · Cruising sources aggregate ★★★ · Cruising sources aggregate ★★★
- **Approaching Bridgetown**: call **Bridgetown Signal Station on VHF 12 (callsign "8P")** before entering; a berth will be assigned; fly a clearly visible **yellow Q flag** on entry. Usual anchorage after clearance is **Carlisle Bay (5–10 m over sand)**, then dinghy/taxi to the offices. The vessel is normally **boarded** by Port Health + Customs + Immigration (~10 min for Free Pratique); the vessel's own forms are accepted. Required: ship's particulars, **list of the last 10 ports visited**, crew and passenger lists, zarpe from the previous port.
...
|---|---|---|
| Extension of tourist stay | Apply at the **Immigration Department** (BTI Corporate Centre, Princess Alice Highway, Bridgetown BB11093 — tel +1 246 535-4100 · imm-dept@caribsurf.com / immigration@barbados.gov.bb) or at the airport/port offices (Grantley Adams +1 246 418-4180 · Passenger Terminal +1 246 535-4172 · Port St. Charles +1 246 535-4178) | [gov.bb — Immigration Contacts](https://www.gov.bb/Departments/immigration) ★★★★★ · [immigration.gov.bb](https://immigration.gov.bb) ★★★★★ |
...
| Item | Rule | Source |
|---|---|---|
| **Temporary admission of foreign yacht** | Private use allowed under temporary import; the yacht must leave the waters at the end of the period granted; charter/sale and commercial use without formal import are prohibited. Usual duration **DATA MISSING** for Barbados specifically (by analogy with OECS/ABC, 6 months is common practice — to be confirmed) | **DATA MISSING** for Barbados-specific customs text ★★ |
| **Cruising permit / anchoring fees** | **DATA MISSING** — no published tariff found on barbadosport.com/BPI as of 28/08/2026 | — |
| **Clearance in/out fee** | **BBD 100 (about US$50)** payable **on exit** according to cruising sources aggregate 2025; to be confirmed at Customs | [Cruising sources aggregate ★★★ |
| **Environmental fee for yachts** | **DATA MISSING** — no government source found for a specific yacht environmental levy | — |
| **Customs/Immigration for yachts** | Formalities free during working hours except for the exit fee above | Cruising sources aggregate ★★★ |

## Vaccinations

| Item | Detail | Source |
|---|---|---|
| Yellow fever requirement | **Not required** for direct arrivals from the EU/Italy/USA. **Required only if you have come from or transited >12 h in a country at risk of transmission** (Amazon basin, sub-Saharan Africa — WHO list). Exemption for Guyana and Trinidad unless there is an urban outbreak according to a secondary source (relevant for routes from South America) | [CDC — Barbados Traveler View](https://wwwnc.cdc.gov/travel/destinations/traveler/none/barbados) ★★★★★ · [NaTHNaC — Barbados](https://travelhealthpro.org.uk/country/9/barbados) ★★★★★ · [IAMAT / traveldoctor.network](https://www.traveldoctor.network/country/barbados/risk/yellow-fever) ★★★ |
| YF certificate validity | **Lifetime from 11/07/2016** (WHO): it cannot be refused for being >10 years old | NaTHNaC / WHO ★★★★★ |
| Age | Required **from 12 months of age** where applicable | [traveldoctor.network](https://www.traveldoctor.network) ★★★ |
| Other vaccines | **No others mandatory** for arrivals from the EU; mosquito protection recommended (dengue present) | [CDC](https://wwwnc.cdc.gov/travel/destinations/traveler/none/barbados) ★★★★★ |
