...
Barbados è una **repubblica parlamentare indipendente** dal 30 novembre 2021 (ex-reame del Commonwealth), membro del Commonwealth, **fuori dall'UE e outside the Schengen Area**: dogana e immigrazione proprie, non OECS. Le regole UE/Schengen non si applicano. [immigration.gov.bb](https://immigration.gov.bb/pages/visitor.aspx) ★★★★★ · [gov.bb — Immigration Department](https://www.gov.bb/Departments/immigration) ★★★★★

## EU Citizens — nessun visto per soggiorni brevi

| Item | Rule | Source |
|---|---|---|
| Visa | **Not required** per cittadini italiani/UE e numerose altre nazionalità per turismo/visita; la lista visti richiesti include solo alcuni paesi (es. Dominican Rep., Haiti, Cuba, Cina ecc. — non UE) | [barbados.org — Documents Required](https://barbados.org/docs_requirements.htm) ★★★ · [immigration.gov.bb — Requirements](https://immigration.gov.bb/pages/visitor.aspx) ★★★★★ |
| Documenti obbligatori | **Valid passport per tutta la durata del soggiorno** (alla partenza deve essere ancora valido); **biglietto di ritorno or proseguimento**; **indirizzo di alloggio** (hotel/appartamento or yacht con ancoraggio/marina); **prova di mezzi sufficienti**; **Immigration & Customs Form online** compilato e ricevute salvate/stampate | [immigration.gov.bb — Visitor Information](https://immigration.gov.bb/pages/visitor.aspx) ★★★★★ · [travelform.gov.bb](https://travelform.gov.bb) ★★★★★ |
| Modulo online obbligatorio | **Immigration and Customs Form** su [travelform.gov.bb](https://travelform.gov.bb) **disponibile entro 72 h prima dell'arrivo**; va compilato online (anche pre-registrazione imbarcazioni) e le **ricevute Immigration + Customs vanno salvate su telefono or stampate** per il controllo all'arrivo | [immigration.gov.bb](https://immigration.gov.bb/pages/visitor.aspx) ★★★★★ · [travelform.gov.bb](https://travelform.gov.bb) ★★★★★ · [barbados.org](https://barbados.org/docs_requirements.htm) ★★★ |
...
⚠️ **Attenzione**: l'ammissione finale spetta sempre all'ufficiale di frontiera al porto d'ingresso; anche senza visto l'ingresso può essere rifiutato or limitato se i requisiti non sono soddisfatti.

## Important Note for Arrival by Sea

- I controlli **persone** (Immigrazione) e **yacht** (Dogana + Port Health + Port Authority) sono **separati ma collegati**: la yacht va presentata al **Port of Entry ufficiale** e l'equipaggio deve aver completato la **Immigration & Customs Form** online. La clearance yacht è obbligatoria all'entrata e all'uscita → vedi [01 — Clearance](01-clearance.md).
...
|---|---|---|
| Proroga soggiorno turistico | Richiesta presso **Immigration Department** (BTI Corporate Centre, Princess Alice Highway, Bridgetown BB11093 — tel +1 246 535-4100 · imm-dept@caribsurf.com / immigration@barbados.gov.bb) or agli uffici aeroporto/porto (Grantley Adams +1 246 418-4180 · Passenger Terminal +1 246 535-4172 · Port St. Charles +1 246 535-4178) | [gov.bb — Immigration Contacts](https://www.gov.bb/Departments/immigration) ★★★★★ · [immigration.gov.bb](https://immigration.gov.bb) ★★★★★ |
| Durata estensione | **DATA MISSING** — nessuna fonte governativa pubblicata trovata con durata massima, fee e moduli proroga turistica al 28/08/2026; verificare con Immigration prima della crociera | — |
...
In pratica: con passaporto italiano si entra senza visto fino a ~90 giorni, con travelform 72h; per restare oltre serve pratica in loco presso Immigration — tempi/costi to be verified.

## The Yacht: ammissione temporanea e tasse

| Item | Rule | Source |
|---|---|---|
| **Ammissione temporanea yacht straniero** | Uso privato consentito in importazione temporanea; la yacht deve lasciare le acque al termine del periodo concesso; vietati noleggio/vendita e uso commerciale senza sdoganamento. Durata prassi **DATA MISSING** per Barbados specifico (per analogia OECS/ABC 6 mesi prassi — da confermare) | **DATA MISSING** per testo doganale Barbados specifico ★★ |
| **Cruising permit / anchor fees** | **DATA MISSING** — nessuna tariffa pubblicata su barbadosport.com/bpi al 28/08/2026 trovata come tariffario ancoraggio | — |
...
| **Tassa ambientale yacht** | **DATA MISSING** — nessuna fonte governativa su tassa ambientale specifica per yacht trovata | — |
| **Dogana/Immigrazione yacht** | Formalità gratuite in orario salvo fee uscita sopra | [Noonsite](https://www.noonsite.com/place/barbados/) ★★★ |

## Vaccinations

| Item | Dettaglio | Fonte |
|---|---|---|
| Obbligo febbre gialla | **Non richiesta** per arrivi diretti da UE/Italia/USA. **Richiesta solo se si proviene or si è transitati >12 h in Paese a rischio trasmissione** (area amazzonica, Africa sub-sahariana — lista OMS). Esenzione per Guyana e Trinidad salvo focolai urbani secondo fonte secondaria (rilevante per rotte dal Sud America) | [CDC — Barbados Traveler View](https://wwwnc.cdc.gov/travel/destinations/traveler/none/barbados) ★★★★★ · [NaTHNaC — Barbados](https://travelhealthpro.org.uk/country/9/barbados) ★★★★★ · [IAMAT / traveldoctor.network](https://www.traveldoctor.network/country/barbados/risk/yellow-fever) ★★★ |
