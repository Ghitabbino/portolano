...
Clima mediterraneo sulla costa tunisia: estati calde/secche, inverni miti. **DATA MISSING** su medie mensili precise — to be verified su servizio meteo nazionale Tunisia.
...
| Servizio | URL | Note |
|---|---|---|
| **DATA MISSING** | **DATA MISSING** | Bollettino marino Tunisia |
