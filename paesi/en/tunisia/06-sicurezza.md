...
| Furti materiali a bordo | **DATA MISSING /5** | **DATA MISSING** — verificare segnalazioni furti dinghy/fuoribordo nelle marine tunisia |
...
- Advisory: **DATA MISSING** — da consultare viaggiareinsicurezza.it (Tunisia), diplomatie.gouv.fr, gov.uk, travel.state.gov, voyage.gc.ca.
...
|---|---|---|
| Emergenza generale UE | **112** | Valido anche in Tunisia se in UE; altrimenti **DATA MISSING** |
| Guardia costiera / MRCC | **DATA MISSING** | Verificare su elenco SAR Tunisia |
