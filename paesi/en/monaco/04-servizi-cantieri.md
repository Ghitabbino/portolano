...
Il principale hub tecnico per Monaco è **DATA MISSING** — da verificare su Port Authority / associazioni nautiche locali.
...
**DATA MISSING** — verificare standard bombole Monaco (scambio/ricarica).
