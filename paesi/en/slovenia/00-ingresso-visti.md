...
| Voce | Regola | Fonte |
|---|---|---|
| Visto | **DATO MANCANTE** — verificare durata soggiorno senza visto per cittadini UE su fonte governativa slovenia | **DATO MANCANTE** |
...
> Dettagli su visti, documenti richiesti e modelli da compilare: **DATO MANCANTE** — da verificare su fonte governativa slovenia ★★★★★ prima della partenza.
...
- **DATO MANCANTE** su procedure specifiche di ingresso via mare per diportisti in Slovenia.
...
| Barca | Regola | Fonte |
|---|---|---|
| **UE con IVA pagata** | **DATO MANCANTE** — libera circolazione in UE, verificare dettagli doganali Slovenia | **DATO MANCANTE** |
| Extra-UE | **DATO MANCANTE** — verificare regime ammissione temporanea Slovenia/UE | **DATO MANCANTE** |
