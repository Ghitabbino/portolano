...
Hub principale **DATA MISSING** — to be verified (possibili poli: Barcellona, Valencia, Palma di Mallorca). Contatto tipico via telefono / WhatsApp; si parla slovenia e spesso inglese. Per lavori importanti chiedere sempre **presupuesto** (preventivo scritto) e confermare i tempi in alta stagione.
...
- **Processing time**: ricambi dall'Europa = 1–2 settimane tipicamente — **DATA MISSING** su dettagli locali.
- **Energia di bordo**: **DATA MISSING**
