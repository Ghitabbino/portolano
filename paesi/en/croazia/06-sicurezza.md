...
| Furti materiali a bordo | **DATA MISSING /5** | **DATA MISSING** — check segnalazioni furti dinghy/fuoribordo nelle marine spagnole |
...
- Advisory: **DATA MISSING** — from consultare viaggiareinsicurezza.it (Croazia), diplomatie.gouv.fr, gov.uk, travel.state.gov, voyage.gc.ca.
- Stampa locale / report isola: **DATA MISSING**.
- Nessuna valutazione definitiva fino a verifica mensile completa.

## Zone Map — Offline

<div class="mapframe" data-slug="croazia" data-minz="5" data-maxz="15" data-lat="44.50" data-lon="15.00" data-zones='[]'></div>

*Legend: **DATA MISSING** — zone from mappare dopo verifica. Mappa placeholder centrata on Mediterraneo croazia.*
...
| Maritime Rescue (Salvamento Marítimo) | **900 202 202 / VHF 16** — **DATA MISSING** from check on SASEMAR |

## Rescue & Emergencies

- **112** numero unico europeo. **VHF 16** monitorato.
- Salvamento Marítimo (SASEMAR) coordina SAR — **DATA MISSING** on dettagli operativi, check on salvamentomaritimo.es ★★★★★.
