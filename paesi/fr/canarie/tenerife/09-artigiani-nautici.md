...
⚠️ Contatti sotto riportati solo se verificati su fonte diretta (siti ufficiali); dove manca la conferma la voce resta (da confermare) e viene ricercata nei controlli mensili. Nulla viene inventato.
...
| Assistenza autorizzata Raymarine | — | (da confermare) | Distribuzione ufficiale Spagna = Azimut Electronics; nessun service Tenerife confermato: da verificare | — |

## Altri operatori

- Meccanici freelance ed elettricisti navali in zona Marina Santa Cruz: elenco da richiedere in capitaineria — (da confermare).
- Sailmaker locali: (da confermare) (Spinnaker tratta veleria ma non risulta loft proprio).

## Dove si trova cosa

- **Lavori seri** (rigging completo, motoristica pesante, grandi raddobbi): si spostano a **Las Palmas de Gran Canaria** — vedi scheda Gran Canaria.
- **Assistenza ordinaria**: hub è la **Marina Santa Cruz** con capitaineria dell'[hub](04-servizi-cantieri.md); varada e officina verificati presso **Varaderos Anaga** (darsena peschereccia).
- **Elettronica B&G/Simrad/Lowrance**: Spinnaker Shop in centro è il riferimento verificato; per **Raymarine** nessun assistente locale confermato ((da confermare)).
...
| Shipchandler dedicato (provisioning nave) | — | (da confermare) | — | Zona portuale Santa Cruz | — |
