...
La costa marocchina mediterranea si estende dallo Stretto di Gibilterra (Tanger Med) a est fino al confine algerino (Saïdia), affacciata sul Mar d'Alboran; l'intera costa marocchina comprende anche il lungo litorale atlantico (da Tanger a Dakhla). **DONNÉE MANQUANTE** su suddivisione ufficiale — da vérifier sur Agence Nationale des Ports (ANP) / Marina Maroc.

### DONNÉE MANQUANTE — area principale / porto di ingresso

- **DONNÉE MANQUANTE** — porti, coordinate, VHF, servizi. Vérifier sur elenco ufficiale Port Authority Marocco.
