...
| Furti materiali a bordo | **DONNÉE MANQUANTE /5** | **DONNÉE MANQUANTE** — verificare segnalazioni furti dinghy/fuoribordo nelle marine tunisia |
...
- Advisory: **DONNÉE MANQUANTE** — da consultare viaggiareinsicurezza.it (Tunisia), diplomatie.gouv.fr, gov.uk, travel.state.gov, voyage.gc.ca.
...
<div class="mapframe" data-slug="tunisia" data-minz="5" data-maxz="15" data-lat="36.80" data-lon="10.30" data-zones='[]'></div>

*Mappa placeholder centrata su Tunisia ( Méditerranée ). Le zone a rischio verranno mappate solo con fonti verificate.*
...
|---|---|---|
| Emergenza generale UE | **112** | Valido anche in Tunisia se in UE; altrimenti **DONNÉE MANQUANTE** |
| Guardia costiera / MRCC | **DONNÉE MANQUANTE** | Vérifier sur elenco SAR Tunisia |
