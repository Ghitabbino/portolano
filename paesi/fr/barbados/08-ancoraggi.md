...
**Dernière vérification: 28/08/2026 · coordinate indicative, navigare con cartografia ufficiale**
...
- **IALA-B** in tutti i Caraïbes: rosso a dritta entrando in porto (invertito rispetto all'Europa). Chiamare sempre **Signal Station Bridgetown VHF 12 ("8P")** per l'ingresso nel porto e per ogni movimento dentro il bacino di Bridgetown. [Barbados Port Inc.](https://barbadosport.com/vessel-documentation) ★★★★★
- **Barriera e reef**: tenersi sempre **>0,5 M** dal reef affiorante a nord-ovest (Six Men's Bay frangente) e **>1 M** dalla costa est atlantica (frangenti continui); entrare in rada solo con buona luce seguendo la batimetrica dei 10 m; di notte solo con waypoints verificati ed eco. ★★
...
### ⛔ Zones d’interdiction absolue (ufficiali / pratiche)
...
- Esistono **parchi marini con boe di ormeggio obbligatorie o raccomandate** (Carlisle relitti, Folkestone): usare la boa se presente è preferibile all'àncora su reef. Vérifier colori locali (giallo/blu day-use).
...
*Clicca sul nome per aprire la scheda completa. Légende: riparo/tenuta = valutazione qualitativa dalle fonti citate (più ★ = meglio). NFL = noforeignland.com (recensioni naviganti, agg. 26/01/2026 ★★). Affluence = alta stagione dic–apr.*
...
| **BA 2487 — Barbados to Tobago** | Caraïbes meridionali | Rotta verso Trinidad/Tobago |
...
- **Holetown / Paynes Bay / Sandy Lane (ovest centrale)**: lunghe spiagge sottovento con ancoraggio possibile su sabbia 3–8 m, ma con **molte boe private degli hotel** e jet-ski — dati e waypoints dettagliati insufficienti per scheda dedicata, **à vérifier** con satellite (200 m off Sandy Lane) ★★
- **Six Men's Bay / Maycock's Bay (nord-ovest vicino a Port St. Charles)**: rade sottovento calme ma con reef frangente vicino all'ingresso — avvicinamento solo con luce, **à vérifier** profondità/boa ★★
...
## Check-list mouillage per Barbados
...
4. Distance dal reef/boe di balneazione rispettata; jet-ski monitorati di giorno a Carlisle ✓
