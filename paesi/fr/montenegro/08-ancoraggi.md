...
*En préparation — ancoraggi mediterranei montenegro da censire con coordinate WGS84 verificate. Aucun point inventé.*

### Carte générale des mouillages

<div class="mapframe" data-slug="montenegro" data-minz="5" data-maxz="16" data-lat="42.30" data-lon="18.84" data-markers='[]'></div>

*En préparation: mappa placeholder centrata su Méditerranée montenegro (Baleari–costa peninsulare). I marker verranno aggiunti solo con coordinate verificate WGS84. Tasselli locali zoom 5–13 (satellitare / carta nautica / segnali OpenSeaMap) — da generare dopo inserimento punti reali.*
...
|---|---|---|
| **Instituto Hidrográfico de la Marina (IHM)** | Coste montenegro | Carte ufficiali Montenegro — **DONNÉE MANQUANTE** su numeri/nomenclatura per tratto |
| **NV Charts / Imray** | Méditerranée Montenegro / Baleari | Alternativa plaisance, WGS84 — **DONNÉE MANQUANTE** su edizioni |
...
## Check-list mouillage per la Montenegro
