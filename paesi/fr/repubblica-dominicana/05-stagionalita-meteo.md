...
- **Climat tropicale marittimo** su tutta l'isola di Hispaniola, latitudine **18–20°N**. Temperature stabili, umidità alta e alisei dominanti. ★★★★
...
|---|---|
| Temperatura media annua | **25–28 °C** in costa (min 18–20 °C su rilievi) |
| Temperatura stagionale | **Saison secca dic–apr: 25–28 °C** con alisei **NE–E 15–20 kt** · **Saison umida mag–nov: più calda e afosa** con rovesci convettivi |
...
|---|---|---|
| **Dicembre – aprile** | **Saison secca (invierno boreale)**: alisei stabili da NE–E 15–20 kt, scrosci brevi, aria più fresca. **Periodo migliore per navigare** sottovento all'isola e per traversate verso Puerto Rico e Turks & Caicos | ★★★★★ |
| **Maggio – novembre** | **Saison umida e ciclonica**: caldo umido, temporali pomeridiani, onde da E–SE, rischio cicloni tropicali. Navigation possibile ma con finestre meteo più corte | ★★★ |
| **01 giugno – 30 novembre** | **Saison ufficiale degli uragani atlantici**, con **picco agosto–ottobre** | ★★★★★ |


## Ouragans — statistiche recenti

| Source | Previsione / Consuntivo | Note |
|---|---|---|
| **NOAA — outlook 2025** | **13–19 tempeste nominate, di cui 6–10 uragani** (di cui 3–5 maggiori) | Outlook stagionale Atlantique ★★★★★ |
| **INDOMET (Instituto Dominicano de Meteorología)** | **~17 tempeste** attese per la stagione 2025 | Ufficio meteo ufficiale RD ★★★★★ |
| Effetti su Hispaniola | L'isola è colpita direttamente in media ogni pochi anni; mareggiate anche con cicloni di passaggio a nord (Turks, Bahamas) o a sud (Caraïbes) | ★★★ |
...
- **Alizés NE–E 15–20 kt** (dic–apr) più tesi nel **Canale della Mona** (tra RD e Puerto Rico) con accelerazioni fino a 25–30 kt e mare incrociato; **Canale del Vento** (Windward Passage, tra Haiti/Est di Cuba) analogo. ★★★
...
| Trajet | Miglia | Finestra consigliata |
|---|---|---|
...
| Samaná → Puerto Rico (Mayagüez) | ~70–100 M | Alizé <18 kt, partenza all'alba per arrivo diurno nel Canale della Mona |
| Santo Domingo → Aruba / Curaçao | ~350–400 M | Alizé stabilizzato, finestra di 3 giorni senza onda ciclonica |
...
|---|---|---|
| **[INDOMET — Instituto Dominicano de Meteorología](https://indomet.gob.do)** | **Sito ufficiale RD**: previsioni nazionali, avvisi, immagini radar/satellite, bollettini marini | ★★★★★ |
| **[ONAMET / INDOMET — avisos marinos](https://indomet.gob.do)** | Bollettini costieri e d'altura per le coste RD | ★★★★★ |
| **[COE — Centro de Operaciones de Emergencias](https://coe.gob.do)** | **Allerte ufficiali** (verde/gialla/rossa) per cicloni, inondazioni, mareggiate — da seguire in stagione umida | ★★★★★ |
| **[NOAA National Hurricane Center](https://www.nhc.noaa.gov)** | Bollettini e traiettorie uragani atlantici (01/06–30/11) | ★★★★★ |
