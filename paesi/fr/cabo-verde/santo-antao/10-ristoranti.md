...
|---|---|---|---|---|---|
| **Ristorante del porto** | Port principale santo-antao | **€–€€** | 🐟 creola | Pesce del giorno, cachupa | A piedi dal pontile ★★ |
...
**DONNÉE MANQUANTE** — tasselli carte hors ligne non ancora generati per santo-antao; usare cartografia ufficiale.
