...
|---|---|---|---|---|---|
| **Ristorante del porto** | Port principale sao-vicente | **€–€€** | 🐟 creola | Pesce del giorno, cachupa | A piedi dal pontile ★★ |
...
**DONNÉE MANQUANTE** — tasselli carte hors ligne non ancora generati per sao-vicente; usare cartografia ufficiale.
