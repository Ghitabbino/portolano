...
|---|---|---|---|---|---|
| **Ristorante del porto** | Port principale brava | **€–€€** | 🐟 creola | Pesce del giorno, cachupa | A piedi dal pontile ★★ |
...
**DONNÉE MANQUANTE** — tasselli carte hors ligne non ancora generati per brava; usare cartografia ufficiale.
