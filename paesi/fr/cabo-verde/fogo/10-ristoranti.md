...
|---|---|---|---|---|---|
| **Ristorante del porto** | Port principale fogo | **€–€€** | 🐟 creola | Pesce del giorno, cachupa | A piedi dal pontile ★★ |
...
**DONNÉE MANQUANTE** — tasselli carte hors ligne non ancora generati per fogo; usare cartografia ufficiale.
