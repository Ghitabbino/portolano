...
|---|---|---|---|---|---|
| **Ristorante del porto** | Port principale maio | **€–€€** | 🐟 creola | Pesce del giorno, cachupa | A piedi dal pontile ★★ |
...
**DONNÉE MANQUANTE** — tasselli carte hors ligne non ancora generati per maio; usare cartografia ufficiale.
