...
| Furti materiali a bordo | **DONNÉE MANQUANTE /5** | **DONNÉE MANQUANTE** — verificare segnalazioni furti dinghy/fuoribordo nelle marine cipro |
...
- Advisory: **DONNÉE MANQUANTE** — da consultare viaggiareinsicurezza.it (Cipro), diplomatie.gouv.fr, gov.uk, travel.state.gov, voyage.gc.ca.
...
*Mappa placeholder centrata su Cipro ( Méditerranée ). Le zone a rischio verranno mappate solo con fonti verificate.*
...
|---|---|---|
| Emergenza generale UE | **112** | Valido anche in Cipro se in UE; altrimenti **DONNÉE MANQUANTE** |
| Guardia costiera / MRCC | **DONNÉE MANQUANTE** | Vérifier sur elenco SAR Cipro |
