...
| Furti materiali a bordo | **DONNÉE MANQUANTE /5** | **DONNÉE MANQUANTE** — verificare segnalazioni furti dinghy/fuoribordo nelle marine turchia |
...
- Advisory: **DONNÉE MANQUANTE** — da consultare viaggiareinsicurezza.it (Turchia), diplomatie.gouv.fr, gov.uk, travel.state.gov, voyage.gc.ca.
...
<div class="mapframe" data-slug="turchia" data-minz="5" data-maxz="15" data-lat="38.00" data-lon="28.50" data-zones='[]'></div>

*Mappa placeholder centrata su Turchia ( Méditerranée ). Le zone a rischio verranno mappate solo con fonti verificate.*
...
|---|---|---|
| Emergenza generale UE | **112** | Valido anche in Turchia se in UE; altrimenti **DONNÉE MANQUANTE** |
| Guardia costiera / MRCC | **DONNÉE MANQUANTE** | Vérifier sur elenco SAR Turchia |
