...
|---|---|---|
| Prolongation soggiorno | Oltre i 3 mesi servono **estensioni presso Immigration Division (Roseau)**; procedura e fee aggiornate: **DONNÉE MANQUANTE** — verificare in loco | ★★ |
| Quota Schengen 90/180 | **Non applicabile**: Dominica è hors de l’espace Schengen e dal territorio UE | ★★★ |
...
## Le bateau: nessun limite di permanenza specifico pubblicato

| Rubrique | Coût | Note |
|---|---|---|
| Pacchetto clearance + tassa turistica | Fee minime in **ECD**; tariffa ufficiale aggiornata: **DONNÉE MANQUANTE** (riferimento pratico 2025: **EC$80 a Portsmouth via PAYS**) | ★★ |
...
Febbre gialla richiesta solo per arrivi da paesi a rischio secondo prassi **IHR/OMS** regionale; nessun vaccino obbligatorio per arrivi diretti da UE. Raccomandata protezione antizanzare (dengue presente in area Caraïbes). Source diretta dedicata a Dominica: **DONNÉE MANQUANTE** — verificare advisory sanitaria locale prima della partenza.
