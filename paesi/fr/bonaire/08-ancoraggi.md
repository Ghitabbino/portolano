...
## Tableau récapitulatif — i migliori ormeggi (solo boe — ancoraggio vietato)

| # | Ormeggio | Tipo boa | Riparo alisei | Fondale / Profondeur | Affluence | Avis de la communauté |
|---|---|---|---|---|---|---|
| 1 | [Champ boe di Kralendijk — Town Moorings](ancoraggi/anc-kralendijk-boe.md) | Bicolore overnight visitatori (30–51 boe) | ★★★★★ ovest sottovento, acqua piatta; swell N/NO esposto | Sabbia/corallo protetto sotto; campo tra 12°09,44' N 68°17,09' W e 12°09,06' N 68°16,41' W | Alta stagione molto pieno (dic–apr) — first-come | ★4,3/5 [NFL, 21/07/2026] ★★ · 30 boe US$35/notte [InfoBonaire ★★★] |
...
| 3 | [Klein Bonaire — No Name Beach](ancoraggi/anc-klein-bonaire.md) | Bouée gialla day-use max 2 h | ★★★ ovest sottovento ma aperto a sud | 5–15 m sabbia/corallo; max 13 m | Diurno affollato 10–14 | iconica gita — pernotto vietato ★★★ |
| 4 | [Salt Pier — boa immersioni](ancoraggi/anc-salt-pier.md) | Bouée gialla day-use immersioni | ★★★ costa sud-ovest | 5–15 m; avvicinarsi solo senza nave Cargill in banchina | Basso; solo diurno | boa dive, non per notte ★★★★ [STINAPA dive map] |

*Clicca sul nome per aprire la scheda completa. Légende: riparo = valutazione qualitativa dalle fonti citate (più ★ = meglio). NFL = noforeignland.com (recensioni naviganti). Affluence = stagionalità dic–apr.*

### Carte générale degli ormeggi
...
|---|---|---|
| **Navionics / C-MAP** elettroniche (regione Caraïbes Meridionali / ABC) | Tutta Bonaire + Klein Bonaire, batimetrie e boe | Carta quotidiana del plotter — mantenere aggiornata |
...
## Check-list mouillage (ancoraggio = vietato)
