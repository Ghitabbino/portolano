...
|---|---|---|
| Sicurezza personale (turisti/crocieristi) | 4/5 | Violenza contro visitatori rara; reati violenti concentrati tra locali e in ambito domestico |
| Furti materiali a bordo | 3/5 | Dinghy/fuoribordo a rischio moderato (8 incidenti CSSN in 5 anni nel raggio di 10 km); furti da auto ai dive sites persistenti |
| Contesto generale dell'isola | 4/5 | Isola low-crime ma con aumento violenza giovanile armata e guida in stato di ebbrezza nel 2025 |
...
*Légende: cerchio rosso tratteggiato = zona con violenza/furti frequenti — cautela soprattutto di notte · cerchio arancio = zona con furti a danno dei crocieristi/auto turistiche. Clicca sul cerchio per il dettaglio.*
...
- Contromisure efficaci riportate dai naviganti/KPCN: catena corta + lucchetto attraverso transito, motore bloccato con bar-lock dedicato, dinghy sollevato a bordo di notte, niente oggetti in vista in auto/dinghy/barca, pattugliamenti KPCN ai dive sites/marinas (2025: sorveglianza mirata aumentata).
...
| Numero unico UE (se da cellulare UE) | **112** (ma usa 911/913 localmente) |

## Sauvetage et urgences

- Numeri: **911 polizia · 912 ambulanza · 919 pompieri · 913 Kustwacht · 133 camera iperbarica · 112 UE**. JRCC/MRCC **Curaçao** coordina SAR per Bonaire/Aruba/Curaçao: **913** (emergenza) o +5999 463-7700/7620, RCC.curacao@mindef.nl (24/7, VHF 16 sempre monitorato).
