...
| Furti materiali a bordo | **DONNÉE MANQUANTE /5** | **DONNÉE MANQUANTE** — verificare segnalazioni furti dinghy/fuoribordo nelle marine francesi |
...
- Advisory: **DONNÉE MANQUANTE** — da consultare viaggiareinsicurezza.it (Francia), diplomatie.gouv.fr, gov.uk, travel.state.gov, voyage.gc.ca.
...
*Légende: **DONNÉE MANQUANTE** — zone da mappare dopo verifica. Mappa placeholder centrata su Méditerranée francese.*
...
| Rischio | Détail | Source |
|---|---|---|
| Posidonia (Baleari (riferimento comparativo)) | Mouillage regolamentato / divieti su posidonia — **DONNÉE MANQUANTE** su dettagli e sanzioni, vérifier sur Govern de les Illes Balears | **DONNÉE MANQUANTE** |
| Traffico marittimo | Aree ad alto traffico (Stretto, Baleari (riferimento comparativo)) — **DONNÉE MANQUANTE** | **DONNÉE MANQUANTE** |
...
| Secours en mer (CROSS) | **900 202 202 / VHF 16** — **DONNÉE MANQUANTE** da vérifier sur CROSS |

## Sauvetage et urgences

- **112** numero unico europeo. **VHF 16** monitorato.
- CROSS (CROSS) coordina SAR — **DONNÉE MANQUANTE** su dettagli operativi, vérifier sur crossmed ★★★★★.
- **DONNÉE MANQUANTE** su altri numeri (Gendarmerie maritime, Policía).
