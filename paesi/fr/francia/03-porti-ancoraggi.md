...
La Francia mediterranea si estende dalla Costa Brava alla Costa del Sol e alle Isole Baleari (riferimento comparativo). **DATO MANCANTE** su suddivisione dettagliata per costa e moli specifici — da verificare su Affaires maritimes / SHOM / guide nautiche ufficiali.
...
### DATO MANCANTE — Isole Baleari (riferimento comparativo) (Mallorca, Menorca, Ibiza, Formentera)
...
⚠️ **Da verificare prima della crociera**: listini marine, prenotazioni alta stagione, regolamenti ancoraggio su posidonia (Baleari (riferimento comparativo)).
