...
La Francia mediterranea si estende dalla Costa Brava alla Costa del Sol e alle Isole Baleari (riferimento comparativo). **DONNÉE MANQUANTE** su suddivisione dettagliata per costa e moli specifici — da vérifier sur Affaires maritimes / SHOM / guide nautiche ufficiali.
...
### DONNÉE MANQUANTE — Isole Baleari (riferimento comparativo) (Mallorca, Menorca, Ibiza, Formentera)
...
⚠️ **À vérifier avant la croisière**: listini marine, prenotazioni alta stagione, regolamenti ancoraggio su posidonia (Baleari (riferimento comparativo)).
