...
*En préparation: mappa placeholder centrata su Egeo / Ionio — Cicladi. I marker verranno aggiunti solo con coordinate verificate WGS84. Tasselli locali zoom 5–13 (satellitare / carta nautica / segnali OpenSeaMap) — da generare dopo inserimento punti reali.*
...
|---|---|---|
| **Hellenic Navy Hydrographic Service (HNHS)** | Coste greche | Carte ufficiali Grecia — Cicladi — **DONNÉE MANQUANTE** su numeri/nomenclatura per tratto |
| **NV Charts / Imray** | Méditerranée Grecia — Cicladi / Baleari | Alternativa plaisance, WGS84 — **DONNÉE MANQUANTE** su edizioni |
...
## Check-list mouillage per la Grecia — Cicladi
