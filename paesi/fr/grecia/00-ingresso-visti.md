...
<b style="color:#4db6ac;">Calcolatore TEPAI 2026 — inserisci LOA fuori tutto (metri o piedi) e mesi</b><br>
...
function calcTepai(){
  ...
  if(isNaN(loa)){ out.innerHTML='Inserisci la lunghezza fuori tutto in metri o piedi (es. 12.59 m / 41.3 ft)'; return; }
  if(loa<=7.0){ out.innerHTML='✅ Esente: ≤7,00 m (22.97 ft) fuori tutto — TEPAI non dovuto'; return; }
  var mensile=0;
