...
| Furti materiali a bordo | **DONNÉE MANQUANTE /5** | **DONNÉE MANQUANTE** — verificare segnalazioni furti dinghy/fuoribordo nelle marine greche |
...
- Advisory: **DONNÉE MANQUANTE** — da consultare viaggiareinsicurezza.it (Grecia — Egeo Settentrionale), diplomatie.gouv.fr, gov.uk, travel.state.gov, voyage.gc.ca.
...
*Légende: **DONNÉE MANQUANTE** — zone da mappare dopo verifica. Mappa placeholder centrata su Grecia — Egeo Settentrionale.*
...
| Secours en mer (JRCC / Hellenic Coast Guard) | **900 202 202 / VHF 16** — **DONNÉE MANQUANTE** da vérifier sur JRCC Piraeus |

## Sauvetage et urgences

- **112** numero unico europeo. **VHF 16** monitorato.
- JRCC / Hellenic Coast Guard (JRCC Piraeus) coordina SAR — **DONNÉE MANQUANTE** su dettagli operativi, vérifier sur hcg.gr ★★★★★.
