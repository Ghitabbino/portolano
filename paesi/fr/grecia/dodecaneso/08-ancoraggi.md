...
<div class="mapframe" data-slug="grecia-dodecaneso" data-minz="5" data-maxz="16" data-lat="36.40" data-lon="27.20" data-markers='[]'></div>

*En préparation: mappa placeholder centrata su Egeo / Ionio — Dodecaneso. I marker verranno aggiunti solo con coordinate verificate WGS84. Tasselli locali zoom 5–13 (satellitare / carta nautica / segnali OpenSeaMap) — da generare dopo inserimento punti reali.*
...
|---|---|---|
| **Hellenic Navy Hydrographic Service (HNHS)** | Coste greche | Carte ufficiali Grecia — Dodecaneso — **DONNÉE MANQUANTE** su numeri/nomenclatura per tratto |
| **NV Charts / Imray** | Méditerranée Grecia — Dodecaneso / Baleari | Alternativa plaisance, WGS84 — **DONNÉE MANQUANTE** su edizioni |
...
## Check-list mouillage per la Grecia — Dodecaneso
