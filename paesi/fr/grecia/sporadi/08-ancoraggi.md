...
<div class="mapframe" data-slug="grecia-sporadi" data-minz="5" data-maxz="16" data-lat="39.10" data-lon="24.00" data-markers='[]'></div>

*En préparation: mappa placeholder centrata su Egeo / Ionio — Sporadi. I marker verranno aggiunti solo con coordinate verificate WGS84. Tasselli locali zoom 5–13 (satellitare / carta nautica / segnali OpenSeaMap) — da generare dopo inserimento punti reali.*
...
|---|---|---|
| **Hellenic Navy Hydrographic Service (HNHS)** | Coste greche | Carte ufficiali Grecia — Sporadi — **DONNÉE MANQUANTE** su numeri/nomenclatura per tratto |
| **NV Charts / Imray** | Méditerranée Grecia — Sporadi / Baleari | Alternativa plaisance, WGS84 — **DONNÉE MANQUANTE** su edizioni |
...
## Check-list mouillage per la Grecia — Sporadi
