...
*En préparation — ancoraggi mediterranei albanii da censire con coordinate WGS84 verificate. Aucun point inventé.*

### Carte générale des mouillages

<div class="mapframe" data-slug="albania" data-minz="5" data-maxz="16" data-lat="41.30" data-lon="19.50" data-markers='[]'></div>

*En préparation: mappa placeholder centrata su Méditerranée albania (Baleari–costa peninsulare). I marker verranno aggiunti solo con coordinate verificate WGS84. Tasselli locali zoom 5–13 (satellitare / carta nautica / segnali OpenSeaMap) — da generare dopo inserimento punti reali.*
...
|---|---|---|
| **Instituto Hidrográfico de la Marina (IHM)** | Coste albanie | Carte ufficiali Albania — **DONNÉE MANQUANTE** su numeri/nomenclatura per tratto |
| **NV Charts / Imray** | Méditerranée Albania / Baleari | Alternativa plaisance, WGS84 — **DONNÉE MANQUANTE** su edizioni |
...
## Check-list mouillage per la Albania
