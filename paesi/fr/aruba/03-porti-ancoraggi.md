...
**Dernière vérification: 27/08/2026** · Coordinate WGS84 in gradi decimali e N/W come da fonte · VHF 16 per Port Control
...
- Clearance: **non in marina**. La dogana per yacht è a **Bateaudera** (vedi [01](01-clearance.md)) — chiamare Port Control VHF 16 a 30' dall'arrivo, bandiera Q, attesa istruzioni. ★★★★★ [Aruba Ports Authority](https://www.arubaports.com)
...
- Ponton dinghy: atterraggio su spiaggia; attenzione al frangente con mare formato — sollevare prua e ancorotto di poppa. Chiudere sempre dinghy e fuoribordo con lucchetto. ★★

## Costa nord-ovest — Malmok, Arashi, California Lighthouse

- Rade di **Arashi / Malmok** (estremità NW): sabbia e qualche chiazza di roccia, 4–10 m; riparo discreto dagli alisei ma aperta a N. Molto frequentata di giorno per snorkeling, tranquilla al tramonto — buon punto di sosta prima di saltare verso Curaçao/Bonaire. ★★ [Sources plaisance agrégées/Cruisers reports] ★★
- Avvicinamento da W: costa bassa con reef affiorante — tenersi a **>0,5 M** dalla scogliera e seguire la batimetrica dei 10 m fino al punto di ancoraggio; di notte entrare solo con waypointss verificati ed eco. ★★

## Costa sopravvento est e sud — Bateaudera, Spanish Lagoon, Baby Beach

- **Bateaudera**: porto commerciale e **unico punto di clearance** per yacht (vedi coordinate in [01](01-clearance.md): ingresso boa 12°28.834' N 70°00.430' W; banchina dogana 12°28.855' N 70°00.014' W). Canale dragato ma trafficato da navi e rimorchiatori — restare nel canale fino al traverso della banchina, poi accostare su istruzione Port Control VHF 16/11. Non è zona di sosta da diporto. ★★★★★ [Aruba Ports Authority] ; ★★★ [Cruising Guide Aruba]
...
Nessun listino pubblico online al 27/08/2026. La marina comunica le tariffe **solo su richiesta** in capitaineria / via mail e richiede **prenotazione anticipata** (pochi posti, alta stagione dic–apr). Gli utenti segnalano che soggiornare in marina include benefit resort (piscina/isola). Indicativamente, tariffazione **al piede/giorno** come nelle ABC (Curaçao ~0,80–1,20 USD/piede), ma **DONNÉE MANQUANTE verificato per Renaissance al 27/08/2026** — chiedere a info@renaissancearuba.com / +297-588-0260 (Wind Creek). ★★ [MailASail 2025 “only one reasonable marina … Renaissance … few berths so booking is mandatory”](http://blog.mailasail.com/doramac/posts/2025/5/26/1668-renaissance-marina); ★★★ [windcreekmarina.com](https://www.windcreekmarina.com/)

| Rubrique | Coût | Note |
|---|---|---|
| Posto pontile / notte (~12 m / 40') | **DONNÉE MANQUANTE** — su richiesta | VHF/capitaineria; alta stagione prenotare con largo anticipo |
| Électricité / acqua | Incluse o a consumo secondo contratto — **DONNÉE MANQUANTE** dettaglio a metro | Vérifier all'arrivo |
| Carburante in banchina | **DONNÉE MANQUANTE** per Renaissance; vedi Varadero sotto | — |

### Varadero Aruba Marina — posti in acqua e rimessaggio

Listino ufficiale non pubblicato sul sito al 27/08/2026; la marina dichiara **“Competitive Rates”** e invia preventivo su richiesta con dati LOA/pescaggio/periodo. Infrastructure nota: addebito **a giorno di calendario** per i posti in acqua, non a notte; elettricità 110/220 V e **acqua gratuita** ai posti. Attività prevalente: **rimessaggio a secco off-customs** per uragani (fuori tassa doganale). ★★★ [varaderoaruba.com](https://www.varaderoaruba.com); [HarbourGuides](https://www.harbourguides.com/bluepages/view/varadero-aruba-marina--boatyard-5487)

| Rubrique | Coût | Note |
|---|---|---|
| Posto in acqua / giorno (~12 m) | **DONNÉE MANQUANTE** — preventivo su richiesta | [varaderoaruba.com/reservation-process](https://www.varaderoaruba.com/reservation-process) ★★★ |
| Rimessaggio a secco (alaggio + sosta) | **DONNÉE MANQUANTE** — preventivo | Fuori dogana durante stagione uraganica |
| Électricité | 110/220 V a pontile | Inclusa secondo contratto ★★★ |
| Eau | **Gratuita** a pontile | ★★★ [HarbourGuides](https://www.harbourguides.com/bluepages/view/varadero-aruba-marina--boatyard-5487) |
...
|---|---|---|
| Boe visita / mooring in riserva marina | Uso obbligatorio dove presenti; tariffa **DONNÉE MANQUANTE** (stimata da guide locali 10–30 USD/notte, da confermare sul posto) | ★★ |
| Mouillage libero | **Gratuito** fuori zone regolamentate e fuori parchi/reef protetti | Rispettare divieti e boe |
| Ponton dinghy | Vérifier tenuta con mare/corrente; chiudere con lucchetto | ★★ |

⚠️ **À vérifier avant la croisière**: disponibilità posti a Renaissance/Varadero in alta stagione (dic–apr) — prenotazione consigliata con settimane di anticipo; tariffe aggiornate al piede e supplemento multiscafo; restrizioni ancoraggio in parchi marini e presso reef; carburante e orari capitaineria (+297 588-3850 Varadero; +297 588-0260 Wind Creek).
...
| Oranjestad — Bateaudera (clearance) | ~5 M via costa | Canale portuale, seguire Port Control VHF 16 |
| Oranjestad — Arashi/Malmok | ~6 M | Sottocosta riparata |
| Aruba — Cartagena (Colombia) | ~310 M | Traversata aperta — finestra meteo |

Distanze ortodromiche approssimate; vérifier sur carta ufficiale. ★★
