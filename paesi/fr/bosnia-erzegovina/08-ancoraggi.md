...
*En préparation — ancoraggi mediterranei bosnia-erzegovini da censire con coordinate WGS84 verificate. Aucun point inventé.*
...
*En préparation: mappa placeholder centrata su Méditerranée bosnia-erzegovina (Baleari–costa peninsulare). I marker verranno aggiunti solo con coordinate verificate WGS84. Tasselli locali zoom 5–13 (satellitare / carta nautica / segnali OpenSeaMap) — da generare dopo inserimento punti reali.*
...
|---|---|---|
| **Instituto Hidrográfico de la Marina (IHM)** | Coste bosnia-erzegovine | Carte ufficiali Bosnia-Erzegovina — **DONNÉE MANQUANTE** su numeri/nomenclatura per tratto |
| **NV Charts / Imray** | Méditerranée Bosnia-Erzegovina / Baleari | Alternativa plaisance, WGS84 — **DONNÉE MANQUANTE** su edizioni |
...
## Check-list mouillage per la Bosnia-Erzegovina
