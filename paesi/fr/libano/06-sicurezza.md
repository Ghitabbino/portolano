...
| Furti materiali a bordo | **DONNÉE MANQUANTE /5** | **DONNÉE MANQUANTE** — verificare segnalazioni furti dinghy/fuoribordo nelle marine libano |
...
- Advisory: **DONNÉE MANQUANTE** — da consultare viaggiareinsicurezza.it (Libano), diplomatie.gouv.fr, gov.uk, travel.state.gov, voyage.gc.ca.
...
*Mappa placeholder centrata su Libano ( Méditerranée ). Le zone a rischio verranno mappate solo con fonti verificate.*
...
|---|---|---|
| Emergenza generale UE | **112** | Valido anche in Libano se in UE; altrimenti **DONNÉE MANQUANTE** |
| Guardia costiera / MRCC | **DONNÉE MANQUANTE** | Vérifier sur elenco SAR Libano |
