...
*En préparation — ancoraggi mediterranei croazii da censire con coordinate WGS84 verificate. Aucun point inventé.*

### Carte générale des mouillages

<div class="mapframe" data-slug="croazia" data-minz="5" data-maxz="16" data-lat="44.50" data-lon="15.00" data-markers='[]'></div>

*En préparation: mappa placeholder centrata su Méditerranée croazia (Baleari–costa peninsulare). I marker verranno aggiunti solo con coordinate verificate WGS84. Tasselli locali zoom 5–13 (satellitare / carta nautica / segnali OpenSeaMap) — da generare dopo inserimento punti reali.*
...
|---|---|---|
| **Instituto Hidrográfico de la Marina (IHM)** | Coste croazie | Carte ufficiali Croazia — **DONNÉE MANQUANTE** su numeri/nomenclatura per tratto |
| **NV Charts / Imray** | Méditerranée Croazia / Baleari | Alternativa plaisance, WGS84 — **DONNÉE MANQUANTE** su edizioni |
...
## Check-list mouillage per la Croazia
