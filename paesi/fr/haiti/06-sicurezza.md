...
|---|---|---|
| **Haiti** — sicurezza generale | **0,5/5** | **Estremo: evitare**. Controllo territoriale di gang armate, rapimenti, collasso servizi, colera endemico. Sconsigliato da tutte le fonti governative e da Sources plaisance agrégées ★★★★★ |
...
- **Evitare la navigazione da diporto in acque haitiane** se non per emergenza. Sources plaisance agrégées: **"Haiti — gang, colera, sconsigliato"**; servizi di soccorso e autorità portuali intermittenti. ★★★★
...
- Fonti da ricontrollare ogni 30 gg: `travel.state.gov` (advisory Haiti), `gov.uk/foreign-travel-advice/haiti`, `voyage.gc.ca`, `Sources plaisance agrégées`, `CSSN (safetyandsecuritynet.org)`, stampa locale haitiana, gruppi FB cruisers Hispaniola. Aggiornare valutazione 0,5/5 e banner L3 se evento <90 gg con 2 fonti ★★★★★. ★★
