...
- Àncora libera consentita fuori dalle zone portuali regolamentate, dai campi boe balneari e dalle **Aree Marine Protette (AMP)** — dove ancoraggio spesso vietato o consentito solo su boe. Vérifier ordinanze locali Capitaneria per Ionio ★★★★★
...
### ⛔ Zone di divieto / AMP in Ionio

| Zone | Divieto | Source |
|---|---|---|
| **DONNÉE MANQUANTE** — AMP / riserva in Ionio | **DONNÉE MANQUANTE** — verificare ordinanza | **DONNÉE MANQUANTE** |
| Zone balneazione / campi boe | Mouillage vietato nei corridoi segnalati | Ordinanza balneare comunale ★★★★ |

Testi e mappe ufficiali: ordinanze Capitaneria di Port competente per Ionio e sito Ministero Ambiente per AMP.

## Tableau récapitulatif — ancoraggi di Ionio
...
*Ancoraggi specifici di Ionio da vérifier sur Portolano IIM, Navionics e fonti locali — tabella da popolare con dati verificati.*

### Carte générale des mouillages

<div class="mapframe" data-slug="ionio" data-minz="6" data-maxz="16" data-lat="38.50" data-lon="17.00" data-markers='[]'></div>

*Mappa centrata su Ionio (38.50N 17.00E, indicativo zona). Marker ancoraggi verificati con coordinate WGS84: **DONNÉE MANQUANTE** — tasselli locali zoom 6–13 (satellitare / carta nautica / segnali OpenSeaMap). Nessuna coordinata inventata: i pin saranno aggiunti solo dopo verifica su fonte attendibile.*
...
|---|---|---|
| **IIM — Carte nautiche italiane** | Ionio | Istituto Idrografico della Marina — WGS84 |
...
- Détail ancoraggi minori di Ionio: **DONNÉE MANQUANTE** — à vérifier

## Check-list mouillage per Ionio
