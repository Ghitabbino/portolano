...
Costa e approdi di Tirreno Centrale: **DATO MANCANTE** per descrizione sistematica verificata. Mappa d'insieme centrata su 41.20N 12.00E (indicativo di zona).

## Marine principali (da verificare)

| Marina / Porto | Zona | Posti | Note |
|---|---|---|---|
| **DATO MANCANTE** | Tirreno Centrale | **DATO MANCANTE** | **DATO MANCANTE** — da verificare su Pagine Azzurre / Capitaneria |
...
⚠️ **Da verificare prima della crociera**: listini ufficiali 2026 delle marine di Tirreno Centrale, telefonicamente o via email.
