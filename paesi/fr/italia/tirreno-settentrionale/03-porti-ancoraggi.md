...
Costa e approdi di Tirreno Settentrionale: **DONNÉE MANQUANTE** per descrizione sistematica verificata. Mappa d'insieme centrata su 42.50N 10.80E (indicativo di zona).

## Marine principali (à vérifier)

| Marina / Port | Zone | Posti | Note |
|---|---|---|---|
| **DONNÉE MANQUANTE** | Tirreno Settentrionale | **DONNÉE MANQUANTE** | **DONNÉE MANQUANTE** — da vérifier sur Pagine Azzurre / Capitaneria |
...
⚠️ **À vérifier avant la croisière**: listini ufficiali 2026 delle marine di Tirreno Settentrionale, telefonicamente o via email.
