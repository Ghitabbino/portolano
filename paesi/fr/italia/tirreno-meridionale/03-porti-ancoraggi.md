...
Costa e approdi di Tirreno Meridionale: **DONNÉE MANQUANTE** per descrizione sistematica verificata. Mappa d'insieme centrata su 39.50N 14.50E (indicativo di zona).

## Marine principali (à vérifier)

| Marina / Port | Zone | Posti | Note |
|---|---|---|---|
| **DONNÉE MANQUANTE** | Tirreno Meridionale | **DONNÉE MANQUANTE** | **DONNÉE MANQUANTE** — da vérifier sur Pagine Azzurre / Capitaneria |
...
⚠️ **À vérifier avant la croisière**: listini ufficiali 2026 delle marine di Tirreno Meridionale, telefonicamente o via email.
