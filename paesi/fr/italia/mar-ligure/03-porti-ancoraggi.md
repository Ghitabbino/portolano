...
Costa e approdi di Mar Ligure: **DONNÉE MANQUANTE** per descrizione sistematica verificata. Mappa d'insieme centrata su 43.90N 8.50E (indicativo di zona).

## Marine principali (à vérifier)

| Marina / Port | Zone | Posti | Note |
|---|---|---|---|
| **DONNÉE MANQUANTE** | Mar Ligure | **DONNÉE MANQUANTE** | **DONNÉE MANQUANTE** — da vérifier sur Pagine Azzurre / Capitaneria |
...
⚠️ **À vérifier avant la croisière**: listini ufficiali 2026 delle marine di Mar Ligure, telefonicamente o via email.
