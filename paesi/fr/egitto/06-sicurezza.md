...
| Furti materiali a bordo | **DONNÉE MANQUANTE /5** | **DONNÉE MANQUANTE** — verificare segnalazioni furti dinghy/fuoribordo nelle marine egitto |
...
- Advisory: **DONNÉE MANQUANTE** — da consultare viaggiareinsicurezza.it (Egitto), diplomatie.gouv.fr, gov.uk, travel.state.gov, voyage.gc.ca.
...
<div class="mapframe" data-slug="egitto" data-minz="5" data-maxz="15" data-lat="31.20" data-lon="29.90" data-zones='[]'></div>

*Mappa placeholder centrata su Egitto ( Méditerranée ). Le zone a rischio verranno mappate solo con fonti verificate.*
...
|---|---|---|
| Emergenza generale UE | **112** | Valido anche in Egitto se in UE; altrimenti **DONNÉE MANQUANTE** |
| Guardia costiera / MRCC | **DONNÉE MANQUANTE** | Vérifier sur elenco SAR Egitto |
