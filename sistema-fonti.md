...
| ★★★ | **Portali curati, stampa locale, associazioni di naviganti strutturate** | Noonsite, France-Antilles, Martinique La 1ère, RCI Martinique, CSSN – Caribbean Safety and Security Net (thecssn.org), Salty Dawg Sailing Association (resoconti datati ma verificati) |
| ★★ | **Forum di naviganti e gruppi Facebook** | CruisersForum, gruppo "Martinique Cruisers", commenti Noonsite |
...
3. **Sicurezza**: si consultano sempre anche i giornali locali (France-Antilles, Martinique La 1ère, RCI), le advisory governative (fr.diplomatie.gouv.fr, voyage.gc.ca, gov.uk), la rete CSSN e i forum dei naviganti, con storico di almeno 5 anni per valutare le tendenze. Ogni paese riceve una **valutazione sicurezza 0–5** (0 = terribile → 5 = molto sicuro) in testa alla pagina sicurezza, rivista a ogni controllo mensile.
