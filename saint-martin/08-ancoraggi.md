...
Selezione di ancoraggi utili per la crociera a Saint-Martin / Sint Maarten. Dettagli completi (coordinate, fondale, protezione, servizi) nelle sottopagine dove presenti.

## Mappa generale

<div class="mapframe" data-slug="saint-martin" data-minz="9" data-maxz="13" data-lat="1804.N" data-lon="6303.W"></div>
...
|---|---|---|---|---|
| **Marigot / Simpson Bay Lagoon (principale)** | Porto / marina + ancoraggio | Buona con alisei ENE | Sabbia/fango 3–8 m | Servizi completi, clearance, provisionning → [03](03-porti-ancoraggi.md) |
...
> Per Saint-Martin / Sint Maarten le guide disponibili indicano pochi ancoraggi ben riparati rispetto a Martinica/Guadalupa; verificare sempre con carte aggiornate e Navionics/C-MAP. **DATO MANCANTE** dove non verificato con websearch. ★★
