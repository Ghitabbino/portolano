...
| Furti materiali a bordo | **DATO MANCANTE /5** | **DATO MANCANTE** — verificare segnalazioni furti dinghy/fuoribordo nelle marine tunisia |
...
- Advisory: **DATO MANCANTE** — da consultare viaggiareinsicurezza.it (Tunisia), diplomatie.gouv.fr, gov.uk, travel.state.gov, voyage.gc.ca.
...
<div class="mapframe" data-slug="tunisia" data-minz="5" data-maxz="12" data-lat="36.80" data-lon="10.30" data-zones='[]'></div>

*Mappa placeholder centrata su Tunisia ( Mediterraneo ). Le zone a rischio verranno mappate solo con fonti verificate.*
...
|---|---|---|
| Emergenza generale UE | **112** | Valido anche in Tunisia se in UE; altrimenti **DATO MANCANTE** |
| Guardia costiera / MRCC | **DATO MANCANTE** | Verificare su elenco SAR Tunisia |
