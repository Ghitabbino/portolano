...
|---|---|---|---|---|---|
| **Warehouse Bonaire (Van den Tweel)** | Kaya Industria, Kralendijk | ~1,5 km dal porto | ✅ sì (15 min) / taxi | DATO MANCANTE | DATO MANCANTE |
...
- Mercato ortofrutticolo del capoluogo (Kralendijk): frutta/verdura locale, mattino presto. ★★
...
| Servizio | Dove | Note |
|---|---|---|
| Water dock | Marina principale Kralendijk Yacht Harbour | DATO MANCANTE tariffa/m³ — verificare in capitainerie → [03](03-porti-ancoraggi.md) |
...
- Minibus / bus locali: frequenti sulle direttrici principali (es. Kralendijk ↔ marina), passaggio ogni 15–30 min di giorno, biglietto ~1–2 USD. ★★
