...
Selezione di ancoraggi utili per la crociera a Santa Lucia. Dettagli completi (coordinate, fondale, protezione, servizi) nelle sottopagine dove presenti.

## Mappa generale

<div class="mapframe" data-slug="santa-lucia" data-minz="9" data-maxz="13" data-lat="1400.N" data-lon="6059.W"></div>
...
|---|---|---|---|---|
| **Rodney Bay / Marigot Bay (principale)** | Porto / marina + ancoraggio | Buona con alisei ENE | Sabbia/fango 3–8 m | Servizi completi, clearance, provisionning → [03](03-porti-ancoraggi.md) |
...
> Per Santa Lucia le guide disponibili indicano pochi ancoraggi ben riparati rispetto a Martinica/Guadalupa; verificare sempre con carte aggiornate e Navionics/C-MAP. **DATO MANCANTE** dove non verificato con websearch. ★★
